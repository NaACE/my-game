...
var collisionCheckBlock = function(testX, testY) {
  for (var i in wall) {
...
var collisionCheckCobblestone = function(testX, testY) {
...
var collisionCheckField = function(testX, testY) {
  for (var i in field) {
...
var collisionCheckPlayer = function(testX, testY) {
...
var collisionCheckEat = function(testX, testY) {
  for (var i in eats) {
...
var collisionCheckEscape = function(testX, testY) {
...
function checkThatBlockEmpty(testX, testY) {
  if (this.collisionCheckBlock(testX, testY) == false && this.collisionCheckCobblestone(testX, testY) == false && this.collisionCheckField(testX, testY) == false && this.collisionCheckPlayer(testX, testY) == false && this.collisionCheckEat(testX, testY) == false && this.collisionCheckEscape(testX, testY) == false) {
    return true;
  } else {
    return false;
  }
...
function checkThatCobblestoneWillFall(cobble, i) {
  if(this.collisionCheckBlock(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckCobblestone(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckField(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckPlayer(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckEat(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckEscape(cobble.x, cobble.y + 64) == false) {
    return true;
  } else if(this.collisionCheckBlock(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckCobblestone(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckField(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckPlayer(cobble.x, cobble.y + 64) == true &&
  cobblFallsXCells[i] >= 1 &&
  this.collisionCheckEat(cobble.x, cobble.y + 64) == false &&
  this.collisionCheckEscape(cobble.x, cobble.y + 64) == false) {
    deathPlayer();
    return true;
...
function dropCobblestone() {
  for (var i in cobblestone) {
    if (this.checkThatCobblestoneWillFall(cobblestone[i], i) == true) {
      var cobb = cobblestone[i];
      cobb.y += 64;
      cobblestone[i].moveTime(cobb, 9999999);
      cobblFallsXCells[i] += 1;
      //cobblestone[i].moveToC(cobb, 0, 1);
    } else if(this.checkThatCobblestoneWillFall(cobblestone[i], i) == false) {
      cobblFallsXCells[i] = 0;
    }
  }
}
function dropFood() {
